...
public class GoogleDriveApi3Util {
    ...
    public String covertDoc2Html(java.io.File uploadFile) {
        try {
            ...
            // 下载文件
            String fp = String.format("/Users/yanzhu/Downloads/其他/1/%s-1.html", uploadFile.getName());
    ...
    public static void main(String... args) throws Exception {
        ...
        String name = "慧亮 人教版地理七年级上册期中测试题C卷.docx";
        java.io.File uploadFile = new java.io.File(String.format("/Users/yanzhu/Downloads/其他/1/%s", name));
